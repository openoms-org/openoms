...
type InvoiceHeader struct {
	...
	SubjectBy              Subject `json:"subjectBy,omitzero"`
	SubjectTo              Subject `json:"subjectTo,omitzero"`
...
type Subject struct {
	IssuedByIdentifier SubjectIdentifier `json:"issuedByIdentifier,omitzero"`
