...
Release fallback obserwuje zmergowane PR-y dotykajace release-relevant pathow i uruchamia `release.yml`, jezeli GitHub nie utworzy normalnego push release runu dla merge SHA.
