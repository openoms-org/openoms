...
- OPE-201: generic Allegro/InPost webhook intake now fails closed when the provider webhook secret is not configured, instead of accepting unsigned events.
