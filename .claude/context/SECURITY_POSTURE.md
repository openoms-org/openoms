...
Production readiness security hardening: 2026-03-15 (ingress rate limiting, weekly Trivy image scan, network policy consolidation, session timeout hook, CSP strict-dynamic removed)
