...
func (h *StoreAuthHandler) SetupShoper(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeError(w, http.StatusBadGateway, "Nie udało się zweryfikować danych Shoper")
		return
	}
...
func (h *StoreAuthHandler) SetupPrestaShop(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeError(w, http.StatusBadGateway, "Nie udało się zweryfikować danych PrestaShop")
		return
	}
...
func (h *StoreAuthHandler) SetupShopify(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeError(w, http.StatusBadGateway, "Nie udało się zweryfikować danych Shopify")
		return
	}
