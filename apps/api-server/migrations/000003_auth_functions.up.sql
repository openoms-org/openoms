...
RETURNS TABLE(id UUID, name VARCHAR, slug VARCHAR, plan plan_type)
SECURITY DEFINER
...
RETURNS TABLE(id UUID, tenant_id UUID, email VARCHAR, name VARCHAR, password_hash VARCHAR, role user_role)
SECURITY DEFINER
SET search_path = public
AS $$
