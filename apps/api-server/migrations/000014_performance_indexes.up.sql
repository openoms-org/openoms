...
-- Note: CONCURRENTLY removed — golang-migrate wraps migrations in transactions,
...
CREATE INDEX IF NOT EXISTS idx_warehouse_stock_product_variant
...
CREATE INDEX IF NOT EXISTS idx_suppliers_sync_active
